...
public class SimpleSWTBrowser {
	...
	private void createSShell() {
		...
		this.locationText.addMouseListener(new MouseAdapter() {
		...
		this.locationText.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				SimpleSWTBrowser.this.browser.setUrl(SimpleSWTBrowser.this.locationText.getText());
			}
		});
		...
		this.homeButton.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
