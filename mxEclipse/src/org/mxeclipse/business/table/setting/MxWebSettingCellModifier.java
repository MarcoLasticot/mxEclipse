...
public class MxWebSettingCellModifier implements ICellModifier {
	MxWebSettingComposite composite;

	public MxWebSettingCellModifier(MxWebSettingComposite composite) {
	...
	public Object getValue(Object element, String property) {
		...
		try {
			if (property.equals("Value")) {
				...
				result = Integer.valueOf(-1);
				ComboBoxCellEditor ed = (ComboBoxCellEditor)this.composite.editors[0];
