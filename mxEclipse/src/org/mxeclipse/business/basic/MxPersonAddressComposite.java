...
public class MxPersonAddressComposite extends MxBusinessBasicComposite {
	...
	public MxPersonAddressComposite(Composite parent, int style, IModifyable view, MxTreeBusiness businessType) {
		super(parent, style);
		this.view = view;
		initialize();
	...
	private void initialize() {
		...
		this.cmbSite.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				MxPersonAddressComposite.this.view.setModified(true);
			}
		});
