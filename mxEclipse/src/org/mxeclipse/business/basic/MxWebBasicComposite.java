...
public class MxWebBasicComposite extends MxBusinessBasicComposite {
	...
	public MxWebBasicComposite(Composite parent, int style, IModifyable view, MxTreeBusiness businessType) { super(parent, style);
	this.view = view;
	initialize();
	...
	private void initialize() {
		...
		this.chkHidden.addSelectionListener(new SelectionAdapter() {
			public void widgetSelected(SelectionEvent e) {
				MxWebBasicComposite.this.view.setModified(true);
			}
		});
	...
	public void storeData() {
		try {
			...
			this.businessType.setLabel(this.txtLabel.getText());
