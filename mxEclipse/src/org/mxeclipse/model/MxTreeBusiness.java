...
public class MxTreeBusiness implements Comparable, Cloneable {
	...
	public static MxTreeBusiness create(String type, String name, String attributeType) throws MxEclipseException, MatrixException {
		Context context = getContext();
		MQLCommand command = new MQLCommand();
	...
	public void delete() throws MxEclipseException, MatrixException {
		Context context = getContext();
		MQLCommand command = new MQLCommand();
