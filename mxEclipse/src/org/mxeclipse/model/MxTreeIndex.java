...
public class MxTreeIndex extends MxTreeBusiness {
	...
	public MxTreeIndex(String name) throws MxEclipseException, MatrixException {
		super("Index", name);
	}
	...
	public static ArrayList getAllIndices(boolean refresh) throws MatrixException, MxEclipseException {
