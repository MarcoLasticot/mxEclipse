...
public abstract class MxTreeAssignment extends MxTreeUser
{
  ...
  public MxTreeAssignment(String type, String name)
  ...
  public static MxTreeAssignment createAssignment(String name)
    throws MxEclipseException, MatrixException
  {
  ...
  public static String getAssignmentType(String name)
    throws MxEclipseException, MatrixException
  {
  ...
  public void addChildAssignment(String assignmentType)
    throws MxEclipseException, MatrixException
  {
  ...
  public void addParentAssignment(String assignmentType)
    throws MxEclipseException, MatrixException
  {
    MxTreeAssignment newAssignment = null;
    if (assignmentType.equals("Role"))
  ...
  public static ArrayList<MxTreeAssignment> getAllAssignments(boolean refresh, String assignmentType)
    throws MatrixException, MxEclipseException
  {
    ...
    if ((assignmentType == null) || (assignmentType.equals("Role"))) {
      ...
      if (assignmentType != null) return retList;
    }
  ...
  public static ArrayList<MxTreeAssignment> getAllAssignments(boolean refresh)
    throws MatrixException, MxEclipseException
  {
