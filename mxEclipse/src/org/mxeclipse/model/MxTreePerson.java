...
public class MxTreePerson extends MxTreeUser
{
  ...
  public static final String[] PERSON_TYPES = { "application", "full", "business", 
    "system", "inactive", "trusted" };
  ...
  public static final String[] PASSWORD_OPTIONS = { "", "No Password", 
    "Disabled", "Change Required", "Never Expires" };
  ...
  public static final String[] ACCESS_OPTIONS = { "read", "modify", "delete", "checkout", 
  ...
  public static final String[] ADMIN_OPTIONS = { "attribute", "type", "relationship", "format", 
  ...
  public MxTreePerson(String name)
  ...
  public static ArrayList<MxTreeAssignment> getAssignments(MxTreePerson person, String assignmentType)
  {
    ...
    try {
      ...
      try {
        ...
        for (Iterator localIterator = ul.iterator(); localIterator.hasNext(); ) { Object oUser = localIterator.next();
          User u = (User)oUser;
          String an = u.getName();
  ...
  public void addAssignment(String assignmentType)
    throws MxEclipseException, MatrixException
  {
  ...
  public void saveAssignments(Context context, MQLCommand command, String assignmentType)
	        throws MatrixException, MxEclipseException
	    {
	        ...
	        for(Iterator iterator = assignments.iterator(); iterator.hasNext();)
	        {
	            ...
	            if(assignment.getOldName().equals(""))
	                command.executeCommand(context, MessageFormat.format(MQL_ADD_ASSIGNMENT, new Object[] {
	                    getName(), assignmentType.toLowerCase(), assignment.getName()
	                }));
	        }
	            ...
	            for(Iterator iterator1 = oldAssignments.iterator(); iterator1.hasNext();)
	            {
	                ...
	                for(Iterator iterator2 = assignments.iterator(); iterator2.hasNext();)
	                {
	                    ...
	                    if(oldAssignment.getName().equals(assignment.getOldName()))
	                    {
	                        ...
	                        command.executeCommand(context, MessageFormat.format(MQL_REMOVE_ASSIGNMENT, new Object[] {
	                            getName(), assignmentType.toLowerCase(), oldAssignment.getOldName()
	                        }));
	                        bFound = true;
	                        break;
	                    }
  ...
  public void savePersonTypes(Context context, MQLCommand command)
  ...
  public void saveRights(Context context, MQLCommand command, boolean adminRights)
    throws MatrixException
  {
