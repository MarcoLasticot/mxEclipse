...
public class MxTreeAttribute extends MxTreeBusiness implements ITriggerable {
	...
	public MxTreeAttribute(String name) throws MxEclipseException, MatrixException {
