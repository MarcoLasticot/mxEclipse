...
public class MxTreeDomainObject implements Comparable {
	...
	public MxTreeDomainObject[] getChildren(boolean forceUpdate) throws MxEclipseException, MatrixException {
		if (forceUpdate) {
			this.children = null;
		}
	...
	public MxTreeDomainObject[] showRevisions() throws MxEclipseException, MatrixException {
		if(children == null) {
